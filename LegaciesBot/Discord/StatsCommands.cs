...
namespace LegaciesBot.Discord
{
    public class StatsCommands : CommandModule<CommandContext>
    {
        ...
        // DISABLED (Season 5): stats come from the site API (Phase 5).
        // To re-enable: restore [Command("stats")] attribute.
        ...
        // DISABLED (Season 5): leaderboard comes from the site API (Phase 5).
        // To re-enable: restore [Command("leaderboard")] attribute.
        ...
        // DISABLED (Season 5): compare comes from the site API (Phase 5).
        // To re-enable: restore [Command("compare")] attribute.
